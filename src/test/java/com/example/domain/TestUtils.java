...
public class TestUtils {
	...
	public static Player createPlayerWithFriends(long facebookID, String name,
			ArrayList<String> friendIDList) {
		String targetURL = "http://localhost:8080/" + appName
				+ "/rest/webService/UserRequest/" + facebookID + "/" + name;
		String JSONInput = "";
		String response = doPOST(targetURL, JSONInput);

		targetURL = "http://localhost:8080/" + appName
